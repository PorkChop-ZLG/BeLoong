...
StartupEvents.registry("item", (event) => {
  ...
  event.create("kubejs:progenitor_dragon_ball").rarity("epic").tooltip([Text.translatable('item.kubejs.progenitor_dragon_ball.tooltip.1')]).tooltip([Text.translatable('item.kubejs.progenitor_dragon_ball.tooltip.2')])
  event.create("kubejs:progenitor_dragon_breath").rarity("epic").tooltip([Text.translatable('item.kubejs.progenitor_dragon_breath.tooltip.1')]).tooltip([Text.translatable('item.kubejs.progenitor_dragon_breath.tooltip.2')])
  // 永恒星光命名空间
